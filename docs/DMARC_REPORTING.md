...
A changed policy gets a separate report. Closed-day reports are sealed before
sending; late observations use successor report IDs and cannot be overwritten by
an acknowledgement. A destination failure does not prevent other destinations
or reports from being attempted. Each report is limited to 10,000 distinct
