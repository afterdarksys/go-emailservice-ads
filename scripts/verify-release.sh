...
go vet ./...
go test -timeout 10m ./...
go test -race -timeout 10m ./internal/confadmin ./cmd/adsemailadm ./internal/extensions ./internal/ha ./internal/auth ./internal/privacy ./internal/imap ./internal/imapserver ./internal/jmap ./internal/auditlog ./internal/bounce ./internal/compliance ./internal/logformat ./internal/oauthaccess ./internal/preservation ./internal/api ./internal/backup ./internal/delivery ./internal/dns ./internal/failover ./internal/filtering ./internal/policy ./internal/security ./internal/smtpd ./internal/storage ./internal/tlsutil
go build ./cmd/...
